...
### M2.6 — 原生 External Overlay（手工验收中）
...
- External 按普通 Z 序紧贴 Taskmgr 正上方，不再全局 Topmost + 前台软隐藏
- TrackNative 继续作为发现加速层；WPF 仅保留 Child

**验收：** 见 [M2.6 迁移方案](research/M2.6-原生ExternalOverlay迁移.md)。
**顺序：** M2.6 手工门禁通过后再恢复 M3 stash。
